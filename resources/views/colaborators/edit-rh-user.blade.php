        ...
        <form action="{{ route('colaborators.rh.update-colaborator') }}" method="post">
            ...
            <div class="container-fluid">
                <div class="gap-3 row">
                    ...
                    {{-- user --}}
                    <div class="p-4 border border-black col">

                        <div class="mb-3">
                            <label for="salary" class="form-label">Salary</label>
                            <input type="number" class="form-control" id="salary" name="salary" step=".01" placeholder="0,00" value="{{ old('salary', $colaborator->detail ? $colaborator->detail->salary : '') }}">
                            @error('salary')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="admission_date" name="admission_date" placeholder="YYYY-mm-dd" value="{{ old('admission_date', $colaborator->detail ? $colaborator->detail->admission_date : '') }}">
